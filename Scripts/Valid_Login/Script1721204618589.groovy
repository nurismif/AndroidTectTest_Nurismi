...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Email'), 'nurismif@gmail.com', 0)

Mobile.setEncryptedText(findTestObject('Object Repository/android.widget.EditText - Kata Sandi'), 'iFGeFYmXIrUhQZHvW7P22w==', 
    0)
